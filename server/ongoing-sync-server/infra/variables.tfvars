...
# x86 i3.xlarge
ongoing_sync_server_ami="ami-02e136e904f3da870"  # Amazon Linux 2 AMI (HVM), SSD Volume Type (64-bit x86)
ongoing_sync_server_instance_type="i3.xlarge"    # @ $0.312/hr, 64-bit x86?, 4 vCPU, 30.5 GiB, 1x950 NVMe SSD, Up to 10 Gigabit
ongoing_sync_server_user_data_file="scripts/user_data_amd64_i3.sh"

# ARM t4g.medium
# ongoing_sync_server_ami="ami-0e341fcaad89c3650"  # Amazon Linux 2 AMI (HVM), SSD Volume Type (64-bit Arm)
# ongoing_sync_server_instance_type="t4g.small"   # $0.0168/hr, 64-bit Arm, 2 vCPU, 2 GiB, EBS Only, Up to 5 Gigabit
